      ...
      <section className="contact-section">
        <div className="contact-info">
          ...
          <div className="info-item">
            <span className="icon purple">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" color="#8d18ff" fill="none" stroke="#8d18ff" strokeWidth="1.5" strokeLinejoin="round">
          ...
          <div className="info-item">
            <span className="icon cyan">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" color="#07c1ff" fill="none" stroke="#07c1ff" strokeWidth="1.5" strokeLinecap="round">
          ...
          <div className="info-item">
            <span className="icon pink">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" color="#e927dc" fill="none" stroke="#e927dc" strokeWidth="1.5">
        ...
        <div className="contact-form-box">
          <form ref={formRef} onSubmit={handleSubmit}>
            ...
            {status === "idle" && <p className="note">We'll get back to you within 24 hours</p>}
            {status === "success" && <p className="note" style={{ color: "#22c55e" }}>✅ Message sent! We'll get back to you within 24 hours.</p>}
            {status === "error" && <p className="note" style={{ color: "#ef4444" }}>❌ Something went wrong. Please try again.</p>}
          </form>
        </div>
      </section>
      <Footer />
